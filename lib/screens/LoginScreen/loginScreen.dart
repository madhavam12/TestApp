...
class LoginPage extends StatelessWidget {
  ...
  Future<bool> showAlert({@required BuildContext context}) {
    return Alert(
        context: context,
          ...
          DialogButton(
            ...
            onPressed: () async {
              ...
              var user = await _auth
                  .sendPasswordResetEmail(forgotPasswordController.text.trim());

              if (user is String) {
                showInSnackBar(
                    context: context, value: "$user", color: Colors.red);
                return 0;
              }
